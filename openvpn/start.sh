...
TRANSMISSION_CONTROL_OPTS="--up-delay --route-up /etc/openvpn/tunnelUp.sh --route-pre-down /etc/openvpn/tunnelDown.sh"
...
exec openvpn --script-security 2 --config ${CHOSEN_OPENVPN_CONFIG} ${TRANSMISSION_CONTROL_OPTS} ${OPENVPN_OPTS}