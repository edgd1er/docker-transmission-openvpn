...
build3: ## build container transmission v3
		...
		@docker buildx build --progress auto --load -f Dockerfile --build-arg aptCacher=192.168.53.208 --build-arg LIBEVENT_VERSION=2.1.12-stable --build-arg TBT_VERSION=3.00 -t edgd1er/transmission-openvpn:tbt_v3 .
