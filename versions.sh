...
TRANSMISSION_VERSION=$(grep -oP "(?<=TBT_VERSION: \")4[^\"]+" .github/workflows/check_version.yml)
TRANSMISSION_DEV_VERSION=$(grep -oP "(?<=DEV_VERSION: \")[^\"]+" .github/workflows/check_version.yml)
TWCV=$(grep -oP "(?<=WC_VERSION: \")[^\"]+" .github/workflows/check_version.yml)
TICV=$(grep -oP "(?<=TC_VERSION: \")[^\"]+" .github/workflows/check_version.yml)
